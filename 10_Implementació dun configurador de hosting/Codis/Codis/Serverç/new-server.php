...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($platform == "WordPress") {
        ...
        // 🔐 Indicar a Ansible la clau privada que ha de fer servir
        putenv("ANSIBLE_PRIVATE_KEY_FILE=/var/www/.ssh/id_rsa");

        // Ruta absoluta i paràmetres
        $cmd = escapeshellcmd("ansible-playbook /var/www/html/playbook-wordpress.yml -i /var/www/html/includes/inventory.ini -e \"site_name=$name\" -e \"admin_user=$user\" -e \"admin_email=$user\"");
