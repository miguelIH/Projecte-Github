...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Execucio del playbook si es WordPress
    if ($platform == "WordPress") {
        putenv("ANSIBLE_PRIVATE_KEY_FILE=/var/www/.ssh/id_rsa");
        $cmd = escapeshellcmd("ansible-playbook /var/www/html/playbook-wordpress.yml -i /var/www/html/includes/inventory.ini -e \"site_name=$name\" -e \"admin_user={$_SESSION['user']}\" -e \"admin_email={$_SESSION['user']}\"");
